...
set
  purpose = coalesce(
    ...
    case
      ...
      when asset_type = 'reference_image' then 'general_reference'
...
create index if not exists assets_project_reference_type_idx
  ...
  where replacement_type is null
    and purpose in ('character_reference', 'scene_reference', 'prop_reference', 'style_reference', 'action_reference', 'audio_reference', 'general_reference');
